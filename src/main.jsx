    ...
    children:[
      {
        ...
        element:<Home/>,
        loader: ()=>{
            return fetch('https://assignment-10-server-tawny-tau.vercel.app/craftitems')
        }
      },
      {
        path:'/login',
      ...
      
      {
        ...
        element: <AllArts/>,
        loader: ()=>{
            return fetch('https://assignment-10-server-tawny-tau.vercel.app/allcrafts')
        }
      },
      {
        ...
        loader: ({params})=>{
            return fetch(`https://assignment-10-server-tawny-tau.vercel.app/craftitem/${params.id}`)
        }
      },
...

      {
        ...
        loader: ({params})=>{
            return fetch(`https://assignment-10-server-tawny-tau.vercel.app/mycrafts/${params.userId}/${params.customized}`)
        }
      },
      {
        ...
        loader: ({params})=>{
            return fetch(`https://assignment-10-server-tawny-tau.vercel.app/artsAndCrafts/${params.subcategory}`)
        }
      },
