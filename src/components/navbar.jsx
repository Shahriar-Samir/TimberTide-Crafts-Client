...
const Navbar = () => {
  ...
  <div className="">
    ...
    <Link to='/' className="font-bold p-0 text-md md:text-2xl lg:text-3xl text-[#cf883c] flex items-center gap-2 ps-2 lg:p-0"><img src="/icons/icon.png" className="w-[25px] md:w-[50px]"/> TimberTide Crafts</Link>
  </div>
